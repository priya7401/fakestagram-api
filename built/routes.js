...
import * as user_controller from "./controllers/user_management/user.js";
import * as attachment_controller from "./controllers/attachment_management/attachment.js";
import * as posts_controller from "./controllers/post_management/posts.js";
import { attachmentMiddleware, verifyToken } from "./app-config/app-config.js";
...
router.get("/user_management/user/user_details", user_controller.get_user_details);
router.put("/user_management/user/update_profile", user_controller.update_profile);
router.get("/user_management/user/follow_requests", user_controller.follow_requests);
router.get("/user_management/user/follow_suggestions", user_controller.follow_sugestions);
...
router.put("/user_management/user/request", user_controller.accept_reject_request);
router.put("/user_management/user/unfollow", user_controller.unfollow_user);
router.put("/user_management/user/remove_follower", user_controller.remove_follower);
